...
export const SCRIPTURE_CHAPTERS = {
  gen: {
    ...
    era: 'Creation and Early Humanity',
    historicalSetting:
      'Genesis 1–6 opens the Bible with God’s creation of a good world, humanity’s calling and rebellion, the spread of sin and death, and God’s just and gracious response as the story moves toward the flood.',
    chapterCount: 50,
    chapters: {
      1: {
        reference: 'Genesis 1',
        summary:
          'In the beginning, God creates the heavens and the earth. By His word He brings light, ordered spaces, vegetation, heavenly lights, sea and flying creatures, land animals, and finally humanity into being. God repeatedly sees His work as good. He creates humankind—male and female—in His image, blesses them, and commissions them to be fruitful, fill the earth, subdue it, and rule over its creatures. God provides food for human beings and animals, sees everything He has made as very good, and completes the ordered work that leads into the seventh-day rest of Genesis 2:1–3.',
        observations: [
          'God exists before creation and is the sole Creator named in the chapter.',
          'God creates by speaking, and what He commands comes to pass.',
          'The earth begins formless and empty, darkness is over the deep, and the Spirit of God hovers over the waters.',
          'God separates and names parts of creation, forming ordered realms and filling them with life.',
          'The repeated pattern of evening and morning marks six days of creative work.',
          'God repeatedly calls His creation good and finally declares the whole completed creation very good.',
          'God creates humanity in His image and likeness, distinguishing human beings within the created order.',
          'Male and female together are created in God’s image and receive His blessing and commission.',
          'Human rule is a vocation received from the Creator, not independent ownership of creation.',
          'God’s completed work in this chapter moves directly toward the seventh day, which He blesses and makes holy in Genesis 2:1–3.',
        ],
        threads: ['creation', 'image', 'reign'],
        lenses: ['Identity → Action', 'Grace → Authority', 'Promise → Fulfillment'],
        scriptureConnections: [
          {
            title: 'Creation through God’s word',
            explanation:
              'Genesis repeatedly says, “God said,” and creation responds. Psalm 33 celebrates the same truth, while John 1, Colossians 1, and Hebrews 1 identify the Son as active in creation. Those later texts deepen the Bible’s witness to the Creator without replacing Genesis’ own emphasis on God’s effective word.',
            passages: ['Gen. 1:1–31', 'Ps. 33:6–9', 'John 1:1–3', 'Col. 1:15–17', 'Heb. 1:1–3'],
          },
          {
            title: 'Humanity bears God’s image',
            explanation:
              'Genesis joins image-bearing with humanity’s commissioned rule. Psalm 8 reflects on humanity’s honored place under God, and the New Testament presents Christ as the true image while describing renewed people as being conformed to Him. Human dignity and vocation begin with God’s gift, not human achievement.',
            passages: ['Gen. 1:26–28', 'Ps. 8:3–8', 'Col. 1:15', 'Col. 3:9–10', 'Heb. 2:5–9'],
          },
          {
            title: 'Blessing and fruitful rule',
            explanation:
              'God blesses living creatures and humanity with fruitfulness, and He entrusts human beings with stewardship under His authority. After the flood, this commission is renewed in a damaged world, showing that God continues His purpose for human life even after judgment.',
            passages: ['Gen. 1:22, 26–30', 'Gen. 9:1–7', 'Ps. 115:16'],
          },
          {
            title: 'From first creation to new creation',
            explanation:
              'The Bible’s closing vision answers the disorder, darkness, curse, and death that enter the story after Genesis 1. Revelation does not merely return to the beginning: God dwells with redeemed humanity, the curse is gone, and His servants reign in the renewed creation.',
            passages: ['Gen. 1:1–5, 26–31', 'Isa. 65:17–25', 'Rev. 21:1–5, 22–25', 'Rev. 22:1–5'],
          },
        ],
        whyItMatters:
          'Genesis 1 gives the biblical story its foundation: the world belongs to the one good and sovereign Creator, matter and embodied life are His good gifts, and every human being possesses God-given dignity as His image-bearer. Human authority is therefore accountable stewardship shaped by God’s blessing and purposes. The chapter also establishes a creation-to-new-creation trajectory. Later Scripture identifies the Son as the agent and goal of creation and looks toward the day when God’s good order, presence, and human rule under Him are fully restored.',
        connectedPassages: [
          'Gen. 2:1–3',
          'Gen. 9:1–7',
          'Ps. 8:3–8',
        ...
        kidSummary:
          'God made the whole world by His word, and everything He made was good. He made people—male and female—in His image, blessed them, and gave them the job of caring for and ruling His world under Him.',
        reflectionQuestions: [
          'What repeated words and patterns show God’s authority and the goodness of His creation?',
          'What does the chapter say is true of both male and female humanity?',
          'How does God’s blessing shape the work He gives human beings to do?',
          'How do John 1 and Revelation 21–22 help us see the larger biblical story that begins here?',
        ],
      },
      2: {
        reference: 'Genesis 2',
        summary:
          'God completes His work, rests on the seventh day, and blesses and makes it holy. The account then focuses closely on the man, whom the LORD God forms from dust and makes alive by breathing into him. God plants Eden, provides beautiful and fruitful trees, and places the man in the garden to work and keep it. He may eat freely except from the tree of the knowledge of good and evil, whose fruit carries the warning of death. Because it is not good for the man to be alone, God brings the animals to him and then forms the woman from his side. The man rejoices in her as his own flesh, and the chapter establishes the one-flesh union of marriage.',
        observations: [
          'God finishes His creative work, rests on the seventh day, blesses it, and makes it holy.',
          'The LORD God forms the man from the dust and breathes into him the breath of life.',
          'God plants a garden in Eden and causes trees that are pleasant to see and good for food to grow there.',
          'The tree of life and the tree of the knowledge of good and evil stand in the garden.',
          'A river flows out of Eden and divides into four rivers.',
          'God places the man in the garden to work it and keep it.',
          'God gives generous permission to eat from the garden while forbidding fruit from one tree and warning of death.',
          'God declares that the man’s aloneness is not good—the first thing in Genesis called not good.',
          'The man names the animals but finds no helper corresponding to him among them.',
          'God forms the woman from the man’s side and brings her to him; the man recognizes shared bone and flesh.',
          'The chapter explains that a man and woman are joined in a one-flesh marriage union.',
          'The man and woman are naked and unashamed.',
        ],
        threads: ['creation', 'image', 'temple', 'reign'],
        lenses: ['Presence → Transformation', 'Identity → Action', 'Grace → Authority'],
        scriptureConnections: [
          {
            title: 'Rest crowns completed creation',
            explanation:
              'God’s rest is the goal of completed work, not recovery from fatigue. The Sabbath command later looks back to this pattern, and Hebrews uses God’s rest to call His people toward faithful trust and the rest that still remains.',
            passages: ['Gen. 2:1–3', 'Ex. 20:8–11', 'Heb. 4:1–11'],
          },
          {
            title: 'Life, vocation, and guarded command',
            explanation:
              'The man receives life from God, abundant provision, meaningful work, and a clear boundary. The verbs translated “work” and “keep” later describe service and guarding in sacred settings. This supports a temple-like reading of Eden within a broader biblical pattern, although Genesis 2 does not explicitly call the garden a temple.',
            passages: ['Gen. 2:7–17', 'Num. 3:7–8', 'Ezek. 28:13–16'],
          },
          {
            title: 'Marriage as one-flesh union',
            explanation:
              'The woman is neither an animal nor an afterthought but the fitting human partner who shares the man’s nature. Jesus cites this chapter when teaching that marriage joins male and female in a God-given, enduring one-flesh union; Paul also uses the passage when speaking of Christ and the church.',
            passages: ['Gen. 2:18–25', 'Matt. 19:4–6', 'Eph. 5:28–32'],
          },
          {
            title: 'Eden’s life reappears in the final city',
            explanation:
              'Revelation’s new-creation vision includes the river of the water of life and the tree of life, now available for the healing of the nations. The Bible’s movement is from gifted but vulnerable garden life to secure life with God and the Lamb.',
            passages: ['Gen. 2:8–14', 'Rev. 21:22–27', 'Rev. 22:1–5'],
          },
        ],
        whyItMatters:
          'Genesis 2 shows human life as gift and calling: people depend on God for breath, place, food, relationship, work, and moral direction. God’s presence and generous provision surround the command, so obedience is a response of trust rather than a way to earn life. The woman answers the man’s aloneness as his corresponding partner, and marriage is rooted in their shared humanity and one-flesh union. Eden also begins patterns of sacred presence, service, life, and guarded access that later Scripture develops through sanctuary imagery and finally resolves in new creation.',
        connectedPassages: [
          'Ex. 20:8–11',
          'Num. 3:7–8',
          'Ps. 104:29–30',
        ...
        kidSummary:
          'God finished His work and made the seventh day special. He made the man alive, gave him a beautiful garden to care for, and gave him one command. God also made the woman to be his fitting partner, and they belonged together without shame.',
        reflectionQuestions: [
          'What gifts and responsibilities does God give the man in the garden?',
          'How does God’s generous permission help us understand His command about the tree?',
          'What does the creation of the woman teach about human relationship and marriage?',
          'Which details connect Eden with later biblical themes of rest, sanctuary, and restored life?',
        ],
      },
      3: {
        reference: 'Genesis 3',
        summary:
          'The serpent questions God’s word and goodness, and the woman and man eat from the forbidden tree. Their eyes are opened to shame, and they cover themselves and hide from the LORD God. God calls them to account; the man blames the woman and indirectly God, while the woman names the serpent’s deception. God judges the serpent, the woman, and the man, introducing hostility, pain, frustrated work, and death into human experience. In the judgment on the serpent, the woman’s offspring will strike his head while being struck at the heel. God clothes the man and woman, then sends them from Eden and guards the way to the tree of life.',
        observations: [
          'The serpent is described as crafty and begins by questioning God’s command.',
          'The serpent denies the warning of death and suggests that God is withholding good from the humans.',
          'The woman sees the tree as good for food, desirable to the eyes, and able to make one wise; she eats and gives fruit to the man, who is with her and eats.',
          'The man and woman become aware of their nakedness, sew coverings, and hide from God.',
          'God seeks the hiding humans with questions and brings their disobedience into the open.',
          'The man blames the woman God gave him, and the woman says the serpent deceived her.',
          'God announces judgment on the serpent, including hostility between the serpent and the woman and between their offspring.',
          'The woman’s offspring will strike or crush the serpent’s head while the serpent strikes his heel.',
          'Pain enters childbearing and conflict enters the relationship between woman and man.',
          'The ground is cursed because of the man; work becomes painful, and humanity will return to dust in death.',
          'The man names his wife Eve because she will be the mother of all living.',
          'The LORD God makes garments of skin and clothes the man and woman.',
          'God expels the humans from Eden and stations cherubim and a flaming sword to guard the way to the tree of life.',
        ],
        threads: ['creation', 'image', 'reign', 'covenant'],
        lenses: ['Truth → Practice', 'Promise → Fulfillment', 'Grace → Authority'],
        scriptureConnections: [
          {
            title: 'Distrust gives birth to disobedience and death',
            explanation:
              'The serpent recasts God’s generous command as deprivation, and the humans grasp what God forbade. Romans traces sin and death entering the human story through Adam and contrasts Adam’s trespass with Christ’s obedient act and gift of life.',
            passages: ['Gen. 2:16–17', 'Gen. 3:1–13', 'Rom. 5:12–21'],
          },
          {
            title: 'The serpent and the woman’s offspring',
            explanation:
              'Observation: God announces continuing hostility and says the woman’s offspring will strike the serpent’s head while the serpent strikes his heel. Interpretation: Genesis does not name Jesus here, but later Christian reading sees this conflict reaching its decisive victory in Christ, who shares human flesh, defeats the devil through death, and will finally crush Satan.',
            passages: ['Gen. 3:14–15', 'Heb. 2:14–15', '1 John 3:8', 'Rom. 16:20', 'Rev. 12:9–11'],
          },
          {
            title: 'Shame, hiding, and God-given clothing',
            explanation:
              'The humans’ own coverings do not end their hiding or restore access to Eden. God’s clothing of them is an act of care within judgment. The text does not explicitly call this a sacrifice, so any connection to later atonement imagery should remain cautious rather than becoming the chapter’s stated explanation.',
            passages: ['Gen. 3:7–10, 21', 'Isa. 61:10'],
          },
          {
            title: 'Exile from life and the promise of restored access',
            explanation:
              'Sin leads eastward out of Eden, and cherubim guard the way to the tree of life. Revelation closes the biblical story with the curse removed, God’s face seen, and the tree of life freely present in the city where God and the Lamb dwell.',
            passages: ['Gen. 3:22–24', 'Rev. 21:3–4, 22–27', 'Rev. 22:1–5, 14'],
          },
        ],
        whyItMatters:
          'Genesis 3 explains why God’s good world is marked by guilt, shame, fractured relationships, painful labor, exile, and death. Sin is not merely rule-breaking; it grows from distrusting God’s word and goodness and seeking wisdom and rule apart from Him. Yet judgment is not the only word. God seeks the hiding pair, clothes them, preserves life, and places within His judgment on the serpent a conflict that points beyond the chapter. Later Scripture identifies Christ’s costly victory over the devil as the decisive answer while looking toward restored access to God and the tree of life in new creation.',
        connectedPassages: [
          'Gen. 2:16–17',
          'Isa. 61:10',
          'Rom. 5:12–21',
        ...
        kidSummary:
          'The serpent tempted the man and woman to doubt God, and they disobeyed Him. Sin brought shame, pain, and death, and they had to leave the garden. But God still cared for them, and He promised that the serpent would not win forever.',
        reflectionQuestions: [
          'How does the serpent try to change the woman’s view of God’s word and goodness?',
          'What happens to the humans’ relationship with themselves, each other, creation, and God after they eat?',
          'What does Genesis 3:15 observe, and how does later Scripture connect that conflict to Christ?',
          'How does Revelation’s tree of life answer the loss and guarded access at the end of this chapter?',
        ],
      },
      4: {
        reference: 'Genesis 4',
        summary:
          'Eve bears Cain and then Abel. Cain works the ground and Abel keeps sheep; both bring offerings, but the LORD regards Abel and his offering rather than Cain and his. When Cain becomes angry, God warns that sin is crouching at the door and must be ruled over. Cain instead murders Abel in the field. God confronts him, hears Abel’s blood crying from the ground, and sentences Cain to restless wandering, yet marks him for protection from vengeance. Cain’s line builds a city and develops livestock keeping, music, and metalwork, but Lamech boasts of escalating violence. Adam and Eve later receive Seth, and in the days of Seth’s son Enosh people begin to call on the LORD’s name.',
        observations: [
          'Cain and Abel are born to Adam and Eve; Cain works the ground, while Abel keeps sheep.',
          'Both brothers bring offerings to the LORD, and Abel brings from the firstborn and fat portions of his flock.',
          'The LORD regards Abel and his offering but does not regard Cain and his offering; Genesis does not say that Cain’s offering failed simply because it was not an animal sacrifice.',
          'Cain becomes very angry, and his face falls.',
          'God questions Cain and warns that sin is crouching at the door, desires him, and must be ruled over.',
          'Cain speaks to Abel, attacks him in the field, and kills him.',
          'God asks Cain where Abel is, and Cain denies responsibility for his brother.',
          'Abel’s blood cries to God from the ground.',
          'Cain is cursed from the ground and sentenced to restless wandering.',
          'God places a mark on Cain to protect him from being killed, restraining vengeance even as judgment remains.',
          'Cain’s descendants build a city and develop livestock keeping, music, and metalworking.',
          'Lamech boasts that his violence deserves vengeance far beyond Cain’s.',
          'Seth is born in Abel’s place, Enosh follows, and people begin to call on the name of the LORD.',
        ],
        threads: ['creation', 'image', 'reign', 'priesthood'],
        lenses: ['Truth → Practice', 'Grace → Authority', 'Identity → Action'],
        scriptureConnections: [
          {
            title: 'Abel’s faithful offering',
            explanation:
              'Genesis emphasizes Abel’s firstborn and fat portions but does not fully explain God’s different regard for the brothers. Hebrews later describes Abel’s offering as made by faith, while 1 John contrasts Abel’s righteous deeds with Cain’s evil ones. Neither passage supports reducing the difference merely to animal versus crop offerings.',
            passages: ['Gen. 4:1–7', 'Heb. 11:4', '1 John 3:11–12'],
          },
          {
            title: 'Sin desires to master Cain',
            explanation:
              'God warns Cain before the murder, describing sin as a predator at the door. The language echoes the distorted desire-and-rule relationship announced in Genesis 3:16, now showing sin’s power pressing upon human action and Cain’s responsibility to resist it.',
            passages: ['Gen. 3:16', 'Gen. 4:6–8', 'James 1:14–15'],
          },
          {
            title: 'Blood cries out; better blood speaks',
            explanation:
              'Abel’s blood cries from the ground for justice. Hebrews contrasts that cry with Jesus’ sprinkled blood, which speaks a better word because His once-for-all sacrifice secures cleansing and access to God rather than only calling for judgment on the murderer.',
            passages: ['Gen. 4:9–12', 'Heb. 12:22–24'],
          },
          {
            title: 'Culture grows while violence spreads',
            explanation:
              'Cain’s line displays real human creativity in city building, herding, music, and metalwork, yet Lamech turns the family story toward pride and multiplied vengeance. Human cultural achievement does not by itself heal alienation from God or master sin.',
            passages: ['Gen. 4:17–24', 'Gen. 6:5, 11–13'],
          },
          {
            title: 'Seth and a preserved family line',
            explanation:
              'Seth is received in place of Abel, and his line leads into the genealogy of Genesis 5. The birth does not erase grief or sin, but it carries the family story forward toward Noah and, across the wider canon, toward Jesus.',
            passages: ['Gen. 4:25–26', 'Gen. 5:1–32', 'Luke 3:23–38'],
          },
        ],
        whyItMatters:
          'Genesis 4 shows sin moving outward from the first couple into worship, anger, brotherhood, murder, denial, society, and boastful violence. God’s warning makes clear that Cain is responsible, while God’s hearing of Abel’s blood shows that hidden violence is not hidden from Him. Judgment and mercy appear together when Cain is exiled yet protected from immediate vengeance. The chapter also refuses easy judgments about culture: skill and development are genuine, but they cannot cure the heart. Hope continues quietly through Seth’s line and the calling on the LORD’s name.',
        connectedPassages: [
          'Gen. 3:16',
          'Gen. 5:1–32',
          'Gen. 6:5, 11–13',
        ...
        kidSummary:
          'Cain became angry when God did not accept his offering, and God warned him about sin. Cain did not listen and killed his brother Abel. God punished Cain but also protected him. People learned many skills, but sin and violence kept growing, while God gave Adam and Eve another son named Seth.',
        reflectionQuestions: [
          'What does the chapter say—and not say—about Cain’s and Abel’s offerings?',
          'How does God warn Cain before Cain murders his brother?',
          'Where do you see both justice and restrained mercy in God’s response to Cain?',
          'What do Cain’s descendants and Seth’s birth show about the different developments continuing through human history?',
        ],
      },
      5: {
        reference: 'Genesis 5',
        summary:
          'Genesis records Adam’s family line through Seth, beginning again with humanity made in God’s likeness, male and female, blessed and named by God. Adam fathers Seth in his own likeness and image. The genealogy then follows generation after generation, repeatedly ending each life with the words “and he died,” confirming the death announced after human rebellion. Enoch breaks the pattern: he walks with God and is not, because God takes him. The line reaches Lamech, who names his son Noah in hope that this child will bring relief from painful work on the ground the LORD has cursed. Noah then fathers Shem, Ham, and Japheth.',
        observations: [
          'The genealogy begins by recalling that God made humanity in His likeness, created male and female, blessed them, and named them.',
          'Adam fathers Seth in his own likeness and after his image.',
          'The chapter traces one line from Adam through Seth rather than attempting to name every descendant of Adam.',
          'Each generation is marked by fatherhood, additional sons and daughters, years lived, and death.',
          'The repeated words “and he died” dominate the genealogy and show death continuing through Adam’s family.',
          'Enoch walks with God for three hundred years after fathering Methuselah.',
          'Enoch does not receive the usual death notice; he is not, because God takes him.',
          'Lamech names his son Noah in hope of rest or relief from the painful work caused by the cursed ground.',
          'The chapter ends by naming Noah’s sons Shem, Ham, and Japheth, preparing for the flood account.',
        ],
        threads: ['image', 'creation', 'covenant'],
        lenses: ['Promise → Fulfillment', 'Identity → Action', 'Presence → Transformation'],
        scriptureConnections: [
          {
            title: 'God’s image continues through Adam’s line',
            explanation:
              'Genesis 5 deliberately repeats the image-and-likeness language of creation and then applies likeness and image language to Adam and Seth. Sin has devastated human life but has not erased humanity’s created identity, a truth reaffirmed after the flood.',
            passages: ['Gen. 1:26–28', 'Gen. 5:1–3', 'Gen. 9:6'],
          },
          {
            title: '“And he died”',
            explanation:
              'The genealogy advances God’s purpose through real generations, but the repeated death notice confirms the judgment announced in Eden. Paul later summarizes this reign of death through Adam and announces resurrection life through Christ.',
            passages: ['Gen. 2:16–17', 'Gen. 3:19', 'Gen. 5:5–31', 'Rom. 5:12–14', '1 Cor. 15:21–22'],
          },
          {
            title: 'Enoch walks with God',
            explanation:
              'Enoch is the striking exception to the chapter’s repeated ending. Hebrews describes him as taken by God and commended as pleasing to Him, making his life a witness to faith amid a genealogy overshadowed by death.',
            passages: ['Gen. 5:21–24', 'Heb. 11:5–6'],
          },
          {
            title: 'Noah and the hope of relief',
            explanation:
              'Lamech connects Noah’s name with hoped-for relief from the toil of the cursed ground. The flood narrative will show Noah receiving favor and becoming the recipient of covenant promises, though he will not remove sin or the curse completely.',
            passages: ['Gen. 3:17–19', 'Gen. 5:28–32', 'Gen. 6:8, 18', 'Gen. 8:20–22', 'Gen. 9:8–17'],
          },
          {
            title: 'The genealogy carries the story toward Christ',
            explanation:
              'Luke includes the line from Jesus back through Noah, Seth, Adam, and God. Genesis 5 is therefore not a pause in the story: it preserves the family line through which the biblical narrative and, ultimately, the promised Savior come.',
            passages: ['Gen. 5:1–32', 'Luke 3:23–38'],
          },
        ],
        whyItMatters:
          'Genesis 5 holds image, death, faith, and hope together. Human beings remain connected to God’s original creation purpose, families continue, and the story moves forward—but no ordinary generation escapes the consequence of sin. Enoch’s exception shows that walking with God matters and that death does not limit God’s authority. The genealogy also preserves the promised line through Seth to Noah. Lamech’s hope for relief raises an expectation the next chapters partly answer, while leaving readers to wait for someone greater who can finally overcome sin, death, and curse.',
        connectedPassages: [
          'Gen. 1:26–28',
          'Gen. 3:17–19',
          'Gen. 6:8, 18',
        ...
        kidSummary:
          'This family list shows that God kept Adam’s family going through Seth. Again and again people lived and died, just as God had warned. But Enoch walked with God, and God took him. When Noah was born, his father hoped he would bring rest from the hard, cursed ground.',
        reflectionQuestions: [
          'Why does the chapter begin by repeating the language of God’s image and blessing?',
          'What does the repeated phrase “and he died” teach about the result of Genesis 3?',
          'How is Enoch different from the genealogy’s repeated pattern?',
          'What hope is attached to Noah’s name, and why does that prepare readers for what comes next?',
        ],
      },
      6: {
        reference: 'Genesis 6',
        summary:
          'As humanity multiplies, Genesis briefly describes the “sons of God,” the daughters of humanity, and the Nephilim. The passage has been understood in several ways, but its surrounding context clearly moves toward divine judgment as corruption increases. The LORD sees that human wickedness is great, that every inclination of the heart is continually evil, and He grieves over what humanity has become. God announces that He will wipe away land creatures, but Noah finds favor with Him. Noah is righteous, blameless in his generation, and walks with God. Because the earth is corrupt and filled with violence, God tells Noah to build an ark, announces a flood, promises to establish His covenant with Noah, and commands him to preserve his family, animal life, and food.',
        observations: [
          'Humanity multiplies, and daughters are born to them.',
          'The “sons of God” take wives from the daughters of humanity; interpreters have understood their identity in several ways, and the chapter does not settle the debate explicitly.',
          'God limits human days in connection with His judgment on corrupt humanity.',
          'The Nephilim are mentioned as being on the earth in those days and afterward; the text gives little detail and does not support elaborate certainty about them.',
          'The LORD sees that human wickedness is great and that every inclination of the human heart is continually evil.',
          'God regrets making humanity and is grieved to His heart.',
          'God announces judgment on humanity and land creatures, but Noah finds favor in His eyes.',
          'Noah is described as righteous and blameless in his generation, and he walks with God.',
          'Noah has three sons: Shem, Ham, and Japheth.',
          'The earth is corrupt before God and filled with violence; all flesh has corrupted its way.',
          'God tells Noah to make an ark of gopher wood with rooms and a protective coating inside and out.',
          'God announces a flood that will destroy flesh under heaven in which is the breath of life.',
          'God promises to establish His covenant with Noah and directs Noah’s family to enter the ark.',
          'God commands Noah to bring animal pairs and food into the ark to preserve life.',
          'Noah does everything God commands him.',
        ],
        threads: ['creation', 'covenant', 'reign'],
        lenses: ['Grace → Authority', 'Rescue → Mission', 'Truth → Practice'],
        scriptureConnections: [
          {
            title: 'A disputed passage within a clear movement',
            explanation:
              'Christians have understood the “sons of God” as heavenly beings, rulers, or members of a particular human line, among other views. The chapter gives too little information to make one reading unquestionable. Its clear narrative emphasis is that human corruption escalates and God’s patience moves toward judgment.',
            passages: ['Gen. 6:1–5', 'Num. 13:32–33'],
          },
          {
            title: 'God sees corruption and grieves',
            explanation:
              'Genesis moves from God seeing creation as very good to seeing deep wickedness and violence. God’s grief shows that judgment is not detached cruelty; the good Creator responds personally and justly to the ruin of creatures and the earth through human evil.',
            passages: ['Gen. 1:31', 'Gen. 6:5–13', 'Ezek. 18:23, 32'],
          },
          {
            title: 'Favor, faith, and obedient preparation',
            explanation:
              'Noah first finds favor, then is described as righteous and as walking with God. Hebrews emphasizes that Noah receives God’s warning by faith and prepares the ark. Grace does not make obedience unnecessary; it forms the setting in which Noah trusts God’s word and acts.',
            passages: ['Gen. 6:8–9, 22', 'Heb. 11:7'],
          },
          {
            title: 'The ark preserves life through judgment',
            explanation:
              'God gives Noah detailed instructions so his household and representatives of animal life will survive the flood. First Peter later uses the flood and ark in explaining baptism—not as a simple one-to-one equation, but as a judgment-and-rescue pattern grounded in Christ’s resurrection.',
            passages: ['Gen. 6:13–22', 'Gen. 7:1–24', '1 Pet. 3:18–22'],
          },
          {
            title: 'God announces covenant before the flood',
            explanation:
              'Before judgment arrives, God promises to establish His covenant with Noah. Genesis 9 will state its terms more fully and extend its sign to Noah’s descendants and every living creature, anchoring the post-flood world in God’s preserving commitment.',
            passages: ['Gen. 6:18–22', 'Gen. 8:20–22', 'Gen. 9:8–17'],
          },
          {
            title: 'The days of Noah and coming judgment',
            explanation:
              'Jesus compares the ordinary life and sudden arrival of the flood in Noah’s days with the coming of the Son of Man. Peter likewise presents the ancient flood as a warning that God will judge evil while preserving those who belong to Him.',
            passages: ['Gen. 6:5–13', 'Matt. 24:36–39', '2 Pet. 2:4–9', '2 Pet. 3:5–13'],
          },
        ],
        whyItMatters:
          'Genesis 6 shows how completely sin has invaded human thought, society, and the earth. Violence is not a small flaw in an otherwise healthy world; it provokes the holy Creator’s grief and judgment. The difficult details of verses 1–4 should not distract from that clear emphasis. At the same time, Noah finds favor, walks with God, believes His warning, and obeys His instructions. God initiates a covenant promise and provides a means to preserve life through judgment. The chapter therefore holds together the seriousness of evil, God’s sorrow and justice, unearned favor, faithful obedience, and the beginning of covenant rescue.',
        connectedPassages: [
          'Gen. 1:31',
          'Gen. 5:21–24',
          'Gen. 8:20–22',
        ...
        kidSummary:
          'People filled the earth with evil and violence, and this made God very sad. God said a flood would judge the ruined world, but Noah found favor with God. Noah trusted God, built the ark just as God commanded, and prepared to keep his family and many animals safe.',
        reflectionQuestions: [
          'What does the chapter clearly emphasize even though the identity of the “sons of God” is debated?',
          'What do God’s seeing, grieving, and judging reveal about His response to human evil?',
          'How are God’s favor toward Noah and Noah’s faithful obedience held together?',
          'How do the ark and covenant promise begin a pattern of preservation through judgment?',
        ],
      },
    },
  },
